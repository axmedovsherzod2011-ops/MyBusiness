...
function OrderCreateModal({ close, save, user }: { close: () => void; save: (d: any) => void; user: User }) {
  const [customerId,setCustomerId]=useState(""),[customerInput,setCustomerInput]=useState(""),[customerPhone,setCustomerPhone]=useState(""),[customerAddress,setCustomerAddress]=useState(""),[discountModal,setDiscountModal]=useState<number|null>(null),[items,setItems]=useState<any[]>([]),[bonusItems,setBonusItems]=useState<any[]>([]),[productQuery,setProductQuery]=useState(""),[bonusQuery,setBonusQuery]=useState(""),[productOptions,setProductOptions]=useState<any[]>([]),[bonusOptions,setBonusOptions]=useState<any[]>([]),[error,setError]=useState(""),[contactErrors,setContactErrors]=useState({phone:false,address:false});
